...
public class EnvironmentMonitorActivity extends BaseActivity{ 
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		titlebar_title.setText(R.string.title_environment_monitor);
	...
	private void initialRoomsGallery(){  
		...
		map.put("ItemText", "仓库1"); 
		map.put("ItemContent", "仓库1"); 
    	lstImageItem.add(map); 
    	map = new HashMap<String, Object>(); 
    	map.put("ItemImage", R.drawable.scene_gallery_1);
		map.put("ItemText", "仓库2"); 
		map.put("ItemContent", "仓库2"); 
    	lstImageItem.add(map);
    	map = new HashMap<String, Object>(); 
    	map.put("ItemImage", R.drawable.scene_gallery_2);
		map.put("ItemText", "仓库3"); 
		map.put("ItemContent", "仓库3"); 
    	lstImageItem.add(map);
		map = new HashMap<String, Object>(); 
    	map.put("ItemImage", R.drawable.scene_gallery_3);
		map.put("ItemText", "仓库4"); 
		map.put("ItemContent", "仓库4"); 
    	lstImageItem.add(map); 
