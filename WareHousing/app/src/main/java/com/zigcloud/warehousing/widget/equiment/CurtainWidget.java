...
public class CurtainWidget extends BaseEquipmentWidget{
	
	public CurtainWidget(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public CurtainWidget(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	} 
	...
	protected void createView(Context context) {
		...
		mView=LayoutInflater.from(context).inflate(R.layout.widget_equipment_curtain, this, true);
