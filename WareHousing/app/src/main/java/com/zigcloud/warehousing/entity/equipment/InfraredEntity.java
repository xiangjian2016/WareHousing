 ...
 * 红外探测器
 * */
public class InfraredEntity extends BaseEquipmentEntity{
	...
	public String getDataValueString() {
		...
		if(equipmentJson!=null&&equipmentJson.appData!=null&&equipmentJson.appData.equipDatas!=null){
			...
			if(equipmentJson.appData.equipDatas.get(0)!=null){
				String dataValue=equipmentJson.appData.equipDatas.get(0).dataValue!=null&&!equipmentJson.appData.equipDatas.get(0).dataValue.equals("00")?"有人":"无人";
