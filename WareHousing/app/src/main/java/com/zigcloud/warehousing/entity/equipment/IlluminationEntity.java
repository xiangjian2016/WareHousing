 ...
 * 光照探测器
 * */
public class IlluminationEntity extends BaseEquipmentEntity {
	...
	public String getDataValueString() { 
		...
		if(equipmentJson!=null&&equipmentJson.appData!=null&&equipmentJson.appData.equipDatas!=null){
			dataValueString="";
			if(equipmentJson.appData.equipDatas.get(0)!=null)dataValueString+=String.format("%s:%s;", "光照",equipmentJson.appData.equipDatas.get(0).dataValue); 
		}
