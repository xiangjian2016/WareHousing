 ...
 * 空气质量探测器
 * */
public class AirQualityEntity extends BaseEquipmentEntity{
	...
	public String getDataValueString() { 
		...
		if(equipmentJson!=null&&equipmentJson.appData!=null&&equipmentJson.appData.equipDatas!=null){
			dataValueString="";
			if(equipmentJson.appData.equipDatas.get(0)!=null)dataValueString+=String.format("%s:%s;", "空气质量",equipmentJson.appData.equipDatas.get(0).dataValue); 
		}
