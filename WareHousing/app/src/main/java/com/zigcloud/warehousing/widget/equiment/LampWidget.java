...
public class LampWidget extends BaseEquipmentWidget{
	
	public LampWidget(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public LampWidget(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	} 
	...
	protected void createView(Context context) {
		...
		mView=LayoutInflater.from(context).inflate(R.layout.widget_equipment_lamp, this, true);
