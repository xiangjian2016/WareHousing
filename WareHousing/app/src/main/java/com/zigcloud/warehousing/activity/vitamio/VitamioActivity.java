...
import com.zigcloud.warehousing.activity.MyMediaController;
...
public class VitamioActivity extends Activity implements Runnable{
    public static  final String TAG = "PlayActivity";

    private VideoView mVideoView;
    private MyMediaController myMediaController;

    String path1 = "http://ivi.bupt.edu.cn/hls/cctv5hd.m3u8";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String bookJson=getIntent().getStringExtra("channel");
        Channel channel=new Gson().fromJson(bookJson,Channel.class);

        mVideoView = (VideoView) findViewById(R.id.surface_view);
        mVideoView.setVideoPath(channel.getCurrentUrl());
